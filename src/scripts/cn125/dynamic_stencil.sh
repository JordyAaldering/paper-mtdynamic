...
SAC_PARALLEL=16 ./bin/stencil_mtd 10000 25000 40000 >> res/cn125/delta_stencil.csv
...
SAC_PARALLEL=16 ./bin/stencil_mtd 10000 25000 40000 >> res/cn125/corridor_stencil.csv
