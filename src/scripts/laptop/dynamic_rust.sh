...
RAYON_NUM_THREADS=16 ./target/release/dynamic 500 1000 1500 >> res/laptop/delta_rust.csv
...
RAYON_NUM_THREADS=16 ./target/release/dynamic 500 1000 1500 >> res/laptop/corridor_rust.csv
