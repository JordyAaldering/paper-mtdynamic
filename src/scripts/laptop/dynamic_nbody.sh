...
SAC_PARALLEL=16 ./bin/nbody_mtd 10000 25000 40000 >> res/laptop/delta_nbody.csv
...
SAC_PARALLEL=16 ./bin/nbody_mtd 10000 25000 40000 >> res/laptop/corridor_nbody.csv
