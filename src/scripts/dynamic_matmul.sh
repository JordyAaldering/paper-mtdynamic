...
SAC_PARALLEL=$threads ./bin/matmul_mtd 500 1000 1500 >> res/$device/delta_matmul.csv
...
SAC_PARALLEL=$threads ./bin/matmul_mtd 500 1000 1500 >> res/$device/corridor_matmul.csv
