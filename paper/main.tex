...
\begin{figure*}
  ...
  \begin{subfigure}[b]{.333\linewidth}
    \caption{10000 bodies}
    \input{img/cn125_nbody_10000.tex}%
  \end{subfigure}%
  \begin{subfigure}[b]{.333\linewidth}
    \caption{25000 bodies}
    \input{img/cn125_nbody_25000.tex}%
  \end{subfigure}%
  \begin{subfigure}[b]{.333\linewidth}
    \caption{40000 bodies}
    \input{img/cn125_nbody_40000.tex}%
  \end{subfigure}%
  \caption{...}%
  \label{fig:nbodynew}
\end{figure*}
...
\begin{figure*}
  ...
  \captionsetup[subfigure]{font=scriptsize,labelformat=empty}
  \begin{subfigure}[b]{.333\linewidth}
    \caption{10000 $\times$ 10000}
    \input{img/cn125_stencil_10000.tex}%
  \end{subfigure}%
  \begin{subfigure}[b]{.333\linewidth}
    \caption{25000 $\times$ 25000}
    \input{img/cn125_stencil_25000.tex}%
  \end{subfigure}%
  \begin{subfigure}[b]{.333\linewidth}
    \caption{40000 $\times$ 40000}
    \input{img/cn125_stencil_40000.tex}%
  \end{subfigure}%
  \caption{...}%
  \label{fig:stencilnew}
\end{figure*}
...
\begin{figure*}
  ...
  \begin{subfigure}[b]{.333\linewidth}
    ...
    \input{img/cn125_matmul_500.tex}%
  \end{subfigure}%
  \begin{subfigure}[b]{.333\linewidth}
    \caption{1000 $\times$ 1000}
    \input{img/cn125_matmul_1000.tex}%
  \end{subfigure}%
  \begin{subfigure}[b]{.333\linewidth}
    \caption{1500 $\times$ 1500}
    \input{img/cn125_matmul_1500.tex}%
  \end{subfigure}%
  \caption{Average energy consumption and runtime of 30 naive matrix multiplications in SaC.
  Bars denote energy consumption, with corresponding values in the left y-axis.
  The line denotes runtime, corresponding to the right y-axis.}%
  \label{fig:matmulnew}
\end{figure*}
...
\begin{figure*}
  ...
  \begin{subfigure}[b]{.333\linewidth}
    \caption{500 $\times$ 500}
    \input{img/cn125_rust_500.tex}%
  \end{subfigure}%
  \begin{subfigure}[b]{.333\linewidth}
    \caption{1000 $\times$ 1000}
    \input{img/cn125_rust_1000.tex}%
  \end{subfigure}%
  \begin{subfigure}[b]{.333\linewidth}
    \caption{1500 $\times$ 1500}
    \input{img/cn125_rust_1500.tex}%
  \end{subfigure}%
  \caption{...}%
  \label{fig:rustnew}
\end{figure*}
