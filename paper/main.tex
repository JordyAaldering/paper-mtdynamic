...
\pgfplotsset{
  ...
  legend image code/.code={
    \path[#1] (0pt,0pt) -- (10pt,0pt) plot coordinates {(5pt,0pt)};
  },
  area legend/.append style={
    legend image code/.code={
      \draw[#1,draw=none] (0pt,-0.5ex) rectangle (10pt,0.5ex);
    }
  },
}
...
\begin{figure*}
  \tiny
  \renewcommand{\epyfigurewidth}{.333\linewidth}
  \hfill
...
\begin{figure}[t]
  ...
  \renewcommand{\epyfigurewidth}{\linewidth}
