...
\begin{figure}[!t]
  ...
  \end{subfigure}%
  \caption{Median energy consumption and runtime of 50 N-body simulation in SaC.
...
\begin{figure}[!t]
  ...
  \end{subfigure}%
  \caption{Median energy consumption and runtime of 50 nine-point stencil operations in SaC.
  Bars denote energy consumption, lines denote runtime.
  Errors are reported as the interquartile range.}%
  \label{fig:stencil}
\end{figure}
...
\begin{figure}[!t]
  ...
  \end{subfigure}%
  \caption{Median energy consumption and runtime of 50 naive matrix multiplications in SaC.
  Bars denote energy consumption, lines denote runtime.
  Errors are reported as the interquartile range.}%
  \label{fig:matmul}
\end{figure}
...
\begin{figure}[!t]
  ...
  \end{subfigure}%
  \caption{Median energy consumption and runtime of 50 naive matrix multiplications in Rust.
  Bars denote energy consumption, lines denote runtime.
  Errors are reported as the interquartile range.}%
  \label{fig:rust}
\end{figure}
